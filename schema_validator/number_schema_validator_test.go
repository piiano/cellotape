...
func TestNumberSchemaValidatorPassForIntType(t *testing.T) {
	...
	validator := NewTypeSchemaValidator(reflect.TypeOf(nil), *numberSchema, router.Options{})
...
func TestFloatFormatSchemaValidatorPassForFloat32Type(t *testing.T) {
	...
	validator := NewTypeSchemaValidator(reflect.TypeOf(nil), *floatSchema, router.Options{})
...
func TestDoubleFormatSchemaValidatorPassForFloat32Type(t *testing.T) {
	...
	validator := NewTypeSchemaValidator(reflect.TypeOf(nil), *doubleSchema, router.Options{})
