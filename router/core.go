...
func createMainRouterHandler(oa *openapi) (http.Handler, error) {
	...
	//unmatchedOperationHandler := chainHandlers(*oa, oa.errorHandlers.unmatchedOperationHandler)
	//router.NotFound = asHttpHandler(*oa, unmatchedOperationHandler)
	//panicHandler := chainHandlers(*oa, oa.errorHandlers.panicHandler)
	//router.NotFound = asHttpHandler(*oa, func(context Context) (RawResponse, error) {
	//	panicHandler()
	//})
...
//
//func asHttpHandler(oa openapi, specOp SpecOperation, head BoundHandlerFunc) http.HandlerFunc {
//	handle := asHttpRouterHandler(oa, specOp, head)
//	return func(writer http.ResponseWriter, request *http.Request) {
//		handle(writer, request, httprouter.Params{})
//	}
//}
